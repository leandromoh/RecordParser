...
namespace RecordParser.Benchmark
{
    ...
    public class VariableLengthWriterBenchmark
    {
        ...
        private static IEnumerable<Person> LoadPeople()
        {
            return new Person[]
            {
                new () { id = new ("ec9a8be9-a000-503b-adcf-7266804f1eb1"), name = "Lilly Bradley", age = 21, birthday = new (1977, 11, 16), gender = Gender.Male, email = "pak@witak.bf", children = true },
                new () { id = new ("63858071-cbb3-5abd-9f88-3dfd565cc4ab"), name = "Lucy Berry", age = 49, birthday = new (1961, 11, 12), gender = Gender.Female, email = "vanvo@ro.pk", children = false },
                new () { id = new ("203804f9-93e7-5510-8bb2-177296bafe6a"), name = "Frank Fox", age = 36, birthday = new (1977, 3, 19), gender = Gender.Male, email = "vav@ped.fj", children = true },

                new () { id = new ("a8af66fb-bad4-51eb-810c-bf3ca22337c6"), name = "Isabel Todd", age = 51, birthday = new (1999, 9, 16), gender = Gender.Female, email = "gu@or.bz", children = false },
                new () { id = new ("1a3d8a66-3e0c-50eb-99c1-a3926bce15ed"), name = "Joseph Scott", age = 55, birthday = new (1986, 10, 26), gender = Gender.Male, email = "bup@vugeb.tt", children = false },
                new () { id = new ("aa7d4395-f10f-5776-9912-e3d86c4b9d3c"), name = "Gilbert Brooks", age = 56, birthday = new (1956, 3, 1), gender = Gender.Female, email = "epiju@ba.ly", children = true },

                new () { id = new ("1d25b811-4002-5744-ac40-93a50f2a442c"), name = "Louis Bennett", age = 25, birthday = new (1967, 4, 4), gender = Gender.Male, email = "ma@itrovive.tv", children = true },
                new () { id = new ("8e963ae5-a9ed-5572-b11c-566abc6a8a56"), name = "Norman Parker", age = 57, birthday = new (1969, 4, 17), gender = Gender.Male, email = "omi@hewepa.bw", children = true },
                new () { id = new ("4d373cfb-79e3-54ce-87ff-f2a08fde8f28"), name = "Gary Doyle", age = 1, birthday = new (1958, 7, 21), gender = Gender.Male, email = "orjohma@cabmofa.ps", children = true },

                new () { id = new ("5af00cdf-0758-5317-bcdf-c9a3337cc266"), name = "Bruce Silva", age = 39, birthday = new (1968, 1, 11), gender = Gender.Female, email = "ta@ovonib.ir", children = true },
            };
        }
