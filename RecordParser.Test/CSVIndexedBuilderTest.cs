...
namespace RecordParser.Test
{
    public class CSVIndexedBuilderTest
    {
        ...
        {
            var reader = new CSVIndexedBuilder<(decimal Debit, decimal Balance, DateTime Date)>()
                .Map(x => x.Balance, 0)
                .Map(x => x.Date, 1)
                .Map(x => x.Debit, 2)
        ...
        {
            var reader = new CSVIndexedBuilder<(string Name, DateTime Birthday, decimal Money, string Nickname)>()
        ...
        {
            var reader = new CSVIndexedBuilder<(int Age, int MotherAge, int FatherAge)>()
        ...
        {
            var reader = new CSVIndexedBuilder<(string Name, decimal Balance, DateTime Date)>()
                .Map(x => x.Balance, 0)
                .Map(x => x.Name, 2)
